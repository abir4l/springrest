...
--
-- Table structure for table `tbl_customer_itenaries`
--

DROP TABLE IF EXISTS `tbl_customer_itenaries`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_customer_itenaries` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `customer_id` int(11) NOT NULL,
  `itenaries_id` int(11) NOT NULL,
  ...
  KEY `tbl_customer_service_tbl_services_FK` (`itenaries_id`),
  KEY `tbl_customer_service_tbl_bill_FK` (`bill_id`),
  CONSTRAINT `tbl_customer_itenaries_tbl_itenaries_FK` FOREIGN KEY (`itenaries_id`) REFERENCES `tbl_itenaries` (`id`),
  ...
  CONSTRAINT `tbl_customer_service_tbl_services_FK` FOREIGN KEY (`itenaries_id`) REFERENCES `tbl_itenaries` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_customer_itenaries`
--

LOCK TABLES `tbl_customer_itenaries` WRITE;
/*!40000 ALTER TABLE `tbl_customer_itenaries` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_customer_itenaries` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tbl_customers` VALUES (3,'Abiral Khanal','abiralkhanal@outlook.com','5454as','Nepali','654654',0,NULL,'2017-05-01 16:58:23',NULL),(4,'Sandhya Nepal','sandhya@nasd.com','asdasdgg45','Nepali',NULL,0,3,'2017-05-01 17:13:49',NULL),(5,'sandhya Nepal','sandhya@nasd.com','asdasdgg45','Nepali',NULL,0,3,NULL,NULL);
...
-- Dump completed on 2017-05-02  7:44:44
